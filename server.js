...
app.post("/api/student/class-reward-vote", isStudent, async (req, res) => {
  ...
  // Alte Stimme löschen, dann neue setzen
  await pool.query(
...
app.post("/api/admin/class-reward-round", isAdmin, async (req, res) => {
  ...
  // Alte Runden derselben Klasse deaktivieren
  await pool.query(
...
app.listen(process.env.PORT || 8080, () => {
  console.log("🚀 Server läuft auf Port 8080 (MULTI-SCHOOL + SUPERADMIN + Klassenbelohnungen)");
});
